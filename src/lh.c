...
void display_help() {
    const char *help_text =
        ...
        ANSI_COLOR_DARK "[" ANSI_COLOR_LIGHT_GREEN "A" ANSI_COLOR_DARK "]" ANSI_COLOR_BLUE "uthentication (Tail)ANSI_COLOR_CYAN "- Stitched logs to trackdown issues in real time"\n" ANSI_COLOR_RESET
