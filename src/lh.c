...
#define ASCII_ART \
    ...
    ANSI_COLOR_LIGHT_GRAY "888                       888    888 d88P\" \"Y88b d88P  Y88b" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "888                       888    888 888     888 888    888" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "888      .d88b.   .d88b.  8888888888 888     888 888       " ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "888     d88\"\"88b d88P\"88b 888    888 888     888 888  88888" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "888     888  888 888  888 888    888 888     888 888    888" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "888     Y88..88P Y88b 888 888    888 Y88b. .d88P Y88b  d88P" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "88888888 \"Y88P\"   \"Y88888 888    888  \"Y88888P\"   \"Y8888P88" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "                       888" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "                  Y8b d88P " ANSI_COLOR_RED " NO" ANSI_COLOR_LIGHT_GRAY " nonsense digital forensics" ANSI_COLOR_RESET "\n" \
    ANSI_COLOR_LIGHT_GRAY "                   \"Y88P\"" ANSI_COLOR_RESET "\n"
